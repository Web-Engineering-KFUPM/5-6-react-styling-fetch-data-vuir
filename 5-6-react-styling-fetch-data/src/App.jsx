  ...
  return (
    <div className="app">
      <header className="bg-primary text-white py-3 mb-4 shadow">
        <Container>
          <h1 className="py-3 mb-4 mt-5 h2 mb-0" >User Management Dashboard</h1>
          <p className="py-3 mb-4 mt-5 mb-0 opacity-75" >Manage and view user information</p>
        </Container>
      </header>
      ...
      <footer className="bg-light py-4 mt-5 py-3, mb-4">
        <Container>
